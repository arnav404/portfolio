...
const projectData = [
{ id: 1, title: 'Worlds Apart', description: 'A co-op game. Players in different but connected worlds must work together to solve puzzles.', image: proj1_banner, show: proj1_show, text: [
    {
        type: 'link',
...
{ id: 3, title: 'arnav.pro', image: proj2_banner, show: proj2_show, text: [
    {
        type: 'link',
