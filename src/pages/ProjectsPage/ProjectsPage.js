      ...
      <div className="scrollable-wrapper">
        <div className="projects-content patterned-box">
          <Container className="projects-container">
            ...
            <Row className="g-0">
              {expData.sort((a, b) => a.id - b.id).map((project) => (
                <Col key={project.id} xs={4} sm={3} md={2} lg={2} className="p-2">
            ...
            <Row className="g-4">
              {projectData.sort((a, b) => a.id - b.id).map((project) => (
                <Col key={project.id} xs={12} sm={6} md={4} lg={4} className="p-2">
